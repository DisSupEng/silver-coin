# Generated by Django 3.2 on 2022-08-04 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.ForeignKey(blank=True, db_column='budget', null=True, on_delete=django.db.models.deletion.CASCADE, to='budget.budget', verbose_name='Budget')),
                ('owner', models.ForeignKey(blank=True, db_column='owner', editable=False, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
