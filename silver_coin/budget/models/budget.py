...
class Budget(models.Model):
    ...
    description = models.CharField(max_length=250, validators=[MaxLengthValidator(250, "Description cannot be greater than 250 characters")], null=False, blank=True, default="", verbose_name="Description")
